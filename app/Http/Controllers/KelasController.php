...
class KelasController extends Controller
{
    ...
    {
        return view('pages.kelas.create', array('level' => $this->level, 'murid' => $this->murid));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.kelas.edit', array('kelas' => $kelas, 'level' => $this->level, 'murid' => $this->murid));
    }
